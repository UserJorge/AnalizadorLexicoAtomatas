...
namespace AnalizadorLexicoAtomatas.Models
{
    ...
    public class DiccionarioDeSimbolos
    {
        ...
        public void Tokens()
        {
            ...
            tSimbolos.Add(tk5);
            TablaDeSimbolos tk6 = new TablaDeSimbolos(6, "INT", "TIY", "Numero entero");
            tSimbolos.Add(tk6);
            TablaDeSimbolos tk7 = new TablaDeSimbolos(7, "DOUBLE", "TIY", " Numero con decimales ");
            tSimbolos.Add(tk7);
            TablaDeSimbolos tk8 = new TablaDeSimbolos(8, "STRING", "TIY", " Cadena de caracteres ");
            tSimbolos.Add(tk8);
            TablaDeSimbolos tk9 = new TablaDeSimbolos(9, "BOOL", "TIY", " Booleano tru or false ");
            tSimbolos.Add(tk9);
            ...
            tSimbolos.Add(tk12);
            TablaDeSimbolos tk13 = new TablaDeSimbolos(13, "DIV", "FUN", "Representa una division ");
            tSimbolos.Add(tk13);
            TablaDeSimbolos tk14 = new TablaDeSimbolos(14, ":=", "ASI", "Simbolo de asignacion ");
            tSimbolos.Add(tk14);
            ...
            tSimbolos.Add(tk18);
            TablaDeSimbolos tk19 = new TablaDeSimbolos(19, "&&", "OPL", "Condicion esto y esto");
            tSimbolos.Add(tk19);
            TablaDeSimbolos tk20 = new TablaDeSimbolos(20, "||", "OPL", "Condicion esto o esto");
            tSimbolos.Add(tk20);
            TablaDeSimbolos tk21 = new TablaDeSimbolos(21, "::", "OPL", "Condicion esto es igual a esto");
            tSimbolos.Add(tk21);
            TablaDeSimbolos tk22 = new TablaDeSimbolos(22, "!:", "OPL", "Condicion diferente a");
            tSimbolos.Add(tk22);
            TablaDeSimbolos tk23 = new TablaDeSimbolos(23, "!", "OPL", "Condicion de negacion");
            tSimbolos.Add(tk23);
            ...
            tSimbolos.Add(tk25);
            TablaDeSimbolos tk26 = new TablaDeSimbolos(26, "METHOD", "REW", "Define una funcion");
            tSimbolos.Add(tk26);
            ...
            tSimbolos.Add(tk28);
            TablaDeSimbolos tk29 = new TablaDeSimbolos(29, "ELSE", "REW", "si tal condicion no se cumple");
            tSimbolos.Add(tk29);
            ...
            tSimbolos.Add(tk35);
            TablaDeSimbolos tk36 = new TablaDeSimbolos(33, ".", "DOT", "Simbolo conversor");
            tSimbolos.Add(tk36);
